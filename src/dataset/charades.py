...
class CharadesDataset(AbstractDataset):
    def __init__(self, config):
        ...
        path = "E:/experiment/TKDE/lgi/LGI4temporalgrounding-master/data/charades/"
        ann_path = path + "annotations/charades_sta_{}.txt".format(self.split)
        aux_ann_path = path + "annotations/Charades_v1_{}.csv".format(self.split)
    ...
    def _get_data_path(self, config):
        ...
        path = "E:/experiment/TKDE/lgi/LGI4temporalgrounding-master/data/charades/"
        root_dir = path + os.path.join(config.get("data_dir", ""), "preprocess")
    ...
    def generate_labels(self, config):
        ...
        if not os.path.exists(self.paths["query_labels"]):
            ...
            path = "E:/experiment/TKDE/lgi/LGI4temporalgrounding-master/data/charades/"
            train_ann_path = path + "annotations/charades_sta_train.txt"
            train_aux_path = path+ "annotations/Charades_v1_train.csv"
...
def get_loader():
    conf = {
        "train_loader": {
            ...
            "video_feature_path": "E:/experiment/TKDE/lgi/LGI4temporalgrounding-master/data/charades/features/i3d_finetuned/{}.npy",
            "max_length": 10,
